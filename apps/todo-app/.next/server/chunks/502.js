...
/* harmony export */ });
/* harmony import */ var _types_theme__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2744);
...
const themeSlice = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createSlice)({
    name: "theme",
    initialState: _types_theme__WEBPACK_IMPORTED_MODULE_0__/* .Theme.LIGHT */ .Q.LIGHT,
    reducers: {
        initTheme: (_, action)=>{
            if (action.payload === _types_theme__WEBPACK_IMPORTED_MODULE_0__/* .Theme.DARK */ .Q.DARK) return _types_theme__WEBPACK_IMPORTED_MODULE_0__/* .Theme.DARK */ .Q.DARK;
            else return _types_theme__WEBPACK_IMPORTED_MODULE_0__/* .Theme.LIGHT */ .Q.LIGHT;
        },
        toggleTheme: (state)=>{
            let newState = _types_theme__WEBPACK_IMPORTED_MODULE_0__/* .Theme.LIGHT */ .Q.LIGHT;
            if (state === _types_theme__WEBPACK_IMPORTED_MODULE_0__/* .Theme.LIGHT */ .Q.LIGHT) newState = _types_theme__WEBPACK_IMPORTED_MODULE_0__/* .Theme.DARK */ .Q.DARK;
            localStorage.setItem("theme", _types_theme__WEBPACK_IMPORTED_MODULE_0__/* .Theme.toString */ .Q.toString(newState));
            return newState;
        }
    }
});
